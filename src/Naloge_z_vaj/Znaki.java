...
public class Znaki {
    ...
    public static void main(String[] args) {
        // 16-bitni znaki
        izpisi16bit((short) 0b1111100111111001); // znak A
        System.out.println();
        izpisi16bit((short) 0b1111100111111000); // znak P
        System.out.println();
        izpisi16bit((short) 0b1110001001001111); // znak 2
        System.out.println();

        izpisi16bit(new short[]{(short) 0b1111100011101000, (short) 0b1111100111111010, (short) 0b1111010001001111}); // FRI
        System.out.println();

        izpisi16bit(kodeZnakov16bit); // cela abeceda
        System.out.println();
        ...
        // 64-bitni znaki
        izpisi64bit(0b0001100000100100010000100100001001111110010000100100001011100111L); // A
        System.out.println();
        izpisi64bit(0b1111111001000001010000010100000101111110010000000100000011100000L); // P
        System.out.println();
        izpisi64bit(0b0111111010000001000000010000011000011000011000011000000111111111L); // 2
        System.out.println();

        izpisi64bit(new long[]{0b1111111101000001010000010100100001111000010010000100000011100000L, 0b0011000001010000000100000001000000010000000100000001000011111111L}); // F1
        System.out.println();

        izpisi64bit(kodeZnakov64bit); // cela abeceda
        System.out.println();
