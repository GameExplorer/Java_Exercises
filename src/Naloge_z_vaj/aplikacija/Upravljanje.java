...
import Naloge_z_vaj.imenik.Imenik;
import Naloge_z_vaj.imenik.Oseba;
...
public class Upravljanje {
    ...
    private static void izpisiNavodila() {
        ...
        System.out.println("1: preberi imenik, 2: izpiši imenik, 3: iskanje po imenu, 4: iskanje po telefonski številki, 5: splošno iskanje, q: izhod, h: pomoč");
    }
                ...
                switch (ukaz) {
                    ...
                    case '1':
                        ...
                        if (imenik.preberiOsebe(vnos))
                            System.out.printf("Imenik uspešno prebran.\n");
                        else
                            System.out.printf("Napaka pri branju imenika.\n");
                        break;
                    case '2':
                        imenik.izpisiImenik();
                        break;
