package Naloge_z_vaj.nakupovanje;
...
public class NakupovalniSeznam {
            ...
            do {
                ...
                switch (ukaz) {
                    ...
                    case '3': // vrini element na mesto
                        ...
                        mesto = sc.nextInt();
                        if (Naloge_z_vaj.zbirke.Seznam.dodajVSeznam(element, mesto))
    ...
    private static boolean extracted7() {
        return Naloge_z_vaj.zbirke.Seznam.uniciSeznam();
    }

    private static void extracted6() {
        Naloge_z_vaj.zbirke.Seznam.izpisiSeznam64Bit();
    }

    private static void extracted5() {
        Naloge_z_vaj.zbirke.Seznam.izpisiSeznam();
    }

    private static int extracted4() {
        return Naloge_z_vaj.zbirke.Seznam.dolzinaSeznama();
    }

    private static String extracted3(int mesto) {
        return Naloge_z_vaj.zbirke.Seznam.odstraniIzSeznama(mesto);
    }

    private static boolean extracted2(String element) {
        return Naloge_z_vaj.zbirke.Seznam.dodajNaKonecSeznama(element);
    }

    private static boolean extracted(int dol) {
        return Naloge_z_vaj.zbirke.Seznam.narediSeznam(dol);
    }
}
